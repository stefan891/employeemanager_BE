...
import it.univr.employeemanager.service.EmployeeService;
...
public class EmployeeResouce {
    ...
    //method that will return all the employee
    // the List is generic we have to specify wat we want to return
    @GetMapping("/all")
